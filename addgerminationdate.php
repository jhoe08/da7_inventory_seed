...
<body>
    ...
    <div class="page-container">
        ...
        <!-- main content area start -->
                            ...
                            mysqli_query($db,"UPDATE product SET date_received='$date_received', category='$category', commodity='$commodity' ,variety='$variety' ,year='$year' ,batch='$batch' ,lot='$lot' ,germination_test_date='$germination_test_date',remarks='$remarks' WHERE product_id='$id'");
                            echo "<script> window.location.href='germination.php'; </script>";
                            }
                            ...
                            $batch                  = $row['batch']; 
                            $lot                    = $row['lot'];                           
                            $germination_test_date  = $row['germination_test_date'];                            
                            $remarks                = $row['remarks'];
                            }
                            else
                            {
                            ...
                            <table border="2">
                            <tr><td colspan="2"><b><font color='Green'><h1>ADD GERMINATION DATE</h1></font></b></td></tr>
                            
                            <tr>
                            <td width="250"><b><font color='#663300'><h4>Date Delivered<em>*</em></h4></font></b></td>
                                <td><label>
                                <input type="date" name="date_received" value="<?php echo $date_received;?>" placeholder="MM-DD-YYYY" readonly="readonly" />
                                </label>
                                </td>
                            </tr>
                            ...
                            <tr><td width="250"><b><font color='#663300'><h4>Commodity<em>*</em></h4></font></b></td>
                                <td><label>
                                <input type="text" name="commodity" value="<?php echo $commodity ?>" readonly="readonly" />
                                </label>
                                </td>
                            </tr>
                            ...
                            <td width="250"><b><font color='#663300'><h4>Variety<em>*</em></h4></font></b></td>
                                <td><label>
                                <input type="text" name="variety" value="<?php echo $variety ?>" readonly="readonly" />
                                </label>
                                </td>
                            </tr>
                            ...
                            <td width="250"><b><font color='#663300'><h4>Procurement Year<em>*</em></h4></font></b></td>
                                <td><label>
                                <input type="text" name="year" value="<?php echo $year;?>" readonly="readonly" />
                                </label>
                                </td>
                            </tr>
                            ...
                            <td width="250"><b><font color='#663300'><h4>Delivery Batch<em>*</em></h4></font></b></td>
                                <td><label>
                                <input type="text" name="batch" value="<?php echo $batch;?>" readonly="readonly" />
                                </label>
                                </td>
                            </tr>
                            ...
                            <td width="250"><b><font color='#663300'><h4>Lot Number<em>*</em></h4></font></b></td>
                                <td><label>
                                <input type="text" name="lot" value="<?php echo $lot;?>" readonly="readonly" />
                                </label>
                                </td>
                            </tr>
                            ...
                            <tr>
                            <td width="250"><b><font color='#663300'><h4>Germination Test Date<em>*</em></h4></font></b></td>
                                <td><label>
                                <input type="date" name="germination_test_date" color="" value="<?php echo $germination_test_date;?>" placeholder="MM-DD-YYYY" />
                                </label>
                                </td>
                            </tr>
                            ...
                            <td width="250"><b><font color='#663300'><h4>Remarks<em>*</em></h4></font></b></td>
                                <td><label>
                                <input type="text" name="remarks" value="<?php echo $remarks;?>" readonly="readonly" />
                                </label>
                                </td>
                            </tr>
                            <tr align="Right">
