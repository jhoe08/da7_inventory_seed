...
<h1 style="text-align:left">Stock Out Items</h1> 
</div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-dark text-center">
                                            <thead class="text-uppercase">
                                                ...
                                                <th scope="col">Number of Bags Delivered</th>
                                                <th scope="col">Total No. of Bags Distributed</th>
                                                <th scope="col">Remaining No. of Bags</th>         
                                                <th scope="col">Remarks</th> 
                                                <th scope="col">Remarks</th>
                                        <th scope="col"><a style="color: red;"><center>✍️👇<br>Out Items</center></a></th>
                                        <th scope="col"><a style="color: green;"><center>👨‍👩‍👧‍👦<br>Beneficiaries</center></th> 
                                                </tr>
                                            </thead>
                                            <tbody>
<?php
                    if(isset($_GET['search']))
                    {
                        ...
                        $filterdata = "SELECT * FROM product WHERE CONCAT(date_received,category,commodity,variety,year,batch,lot,bags,grandtotal_bags_distributed,grandtotal_remaining_bags,remarks) LIKE '%$filtervalue%'";
                            ...
                            foreach($filterdata_run as $row)
                            {
                                ?>
                                    <tr>
                                      ...
                                      <th> 
                                           <a style="color:red;" href="out.php?id=<?php echo $row["product_id"] ?>">Out</a> 
                                      </th>
                                      <th> 
                                            <a style="color:green;" href="beneficiary.php?id=<?php echo $row["product_id"] ?>">View</a> 
                                      </th>
                                    </tr>
                                <?php
                            }
